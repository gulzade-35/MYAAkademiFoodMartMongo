...
namespace FoodMartMongo.Mapping
{
    public class GeneralMapping : Profile
    {
        public GeneralMapping()
        {
            ...
            CreateMap<Discount, GetCategoryByIdDto>().ReverseMap();

            CreateMap<People, ResultPeopleDto>().ReverseMap();
            CreateMap<People, CreatePeopleDto>().ReverseMap();
            CreateMap<People, UpdatePeopleDto>().ReverseMap();
            CreateMap<People, GetPeopleByIdDto>().ReverseMap();
